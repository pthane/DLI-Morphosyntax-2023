...
Participants <- read_csv("../PoLaR Presentation/PoLaR Participant Table.csv")
```
...
DOM_Overall_Plot <- plot_model(DOM_Overall, show.values = TRUE, show.intercept = TRUE, value.offset = .3, transform = NULL, vline.color = "black") +
                scale_y_continuous(breaks = seq(-6, 6, 2),
                     limits = c(-6, 6)) +
          scale_x_discrete(labels = c("MST : Freq. of use", "Frequency of use of Spanish", "Morphology selection task (MST)", "MLS-5 group", "DLI-5 group", "MLS-7/8 group", "(Intercept)")) +
