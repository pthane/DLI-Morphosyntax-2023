...
# EPT
SDB_EPT_Subj <- read.csv(here("./CSV Files/SDB/SDB Subjunctive EPT.csv")) %>% 
  mutate(Group = "SDBA",
         GradeGroup = "SDBA",
         ChildGroup = "N/A",
         Task = "SCT",
...
HSA_EPT_Subj <- read.csv(here("./CSV Files/Adult HS/Adult HS Subjunctive EPT.csv")) %>% 
  mutate(Group = "HSA",
         GradeGroup = "N/A",
         ChildGroup = "N/A",
         Task = "SCT",
...
DLI78_EPT_Subj <- read.csv(here("./CSV Files/DLI-78/DLI-78 Subjunctive EPT.csv")) %>% 
  mutate(Group = "HS7/8",
...
MLS78_EPT_Subj <- read.csv(here("./CSV Files/MLS-78/MLS-78 Subjunctive EPT.csv")) %>% 
  filter(!School == "GBCS") %>%
  mutate(Group = "HS7/8",
         GradeGroup = "7th/8th grade",
         ChildGroup = "MLS-7/8",
...
DLI5_EPT_Subj <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive EPT.csv")) %>% 
  mutate(Group = "HS5",
...
MLS5_EPT_Subj <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive EPT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  mutate(Group = "HS5",
         GradeGroup = "5th grade",
         ChildGroup = "MLS-5",
...
# FCT
SDB_FCT_Subj <- read.csv(here("./CSV Files/SDB/SDB Subjunctive FCT.csv")) %>% 
  mutate(Group = "SDBA",
         GradeGroup = "SDBA",
         ChildGroup = "N/A",
         Task = "MST",
...
HSA_FCT_Subj <- read.csv(here("./CSV Files/Adult HS/Adult HS Subjunctive FCT.csv")) %>% 
  mutate(Group = "HSA",
         GradeGroup = "N/A",
         ChildGroup = "N/A",
         Task = "MST",
...
DLI78_FCT_Subj <- read.csv(here("./CSV Files/DLI-78/DLI-78 Subjunctive FCT.csv")) %>% 
  mutate(Group = "HS7/8",
         GradeGroup = "7th/8th grade",
         ChildGroup = "DLI-7/8",
         Task = "MST",
...
MLS78_FCT_Subj <- read.csv(here("./CSV Files/MLS-78/MLS-78 Subjunctive FCT.csv")) %>% 
  filter(!School == "GBCS") %>%
  mutate(Group = "HS7/8",
         GradeGroup = "7th/8th grade",
         ChildGroup = "MLS-7/8",
...
DLI5_FCT_Subj <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive FCT.csv")) %>% 
  mutate(Group = "HS5",
         GradeGroup = "5th grade",
         ChildGroup = "DLI-5",
         Task = "MST",
...
MLS5_FCT_Subj <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive FCT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  mutate(Group = "HS5",
         GradeGroup = "5th grade",
         ChildGroup = "MLS-5",
...
```{r, load-DOM-data}
# EPT
SDB_EPT_DOM <- read.csv(here("./CSV Files/SDB/SDB DOM EPT.csv")) %>% 
  mutate(Group = "SDBA",
         GradeGroup = "SDBA",
         ChildGroup = "N/A",
         Task = "SCT",
...
HSA_EPT_DOM <- read.csv(here("./CSV Files/Adult HS/Adult HS DOM EPT.csv")) %>% 
  mutate(Group = "HSA",
         GradeGroup = "N/A",
         ChildGroup = "N/A",
         Task = "SCT",
...
DLI78_EPT_DOM <- read.csv(here("./CSV Files/DLI-78/DLI-78 DOM EPT.csv")) %>% 
  mutate(Group = "HS7/8",
         GradeGroup = "7th/8th grade",
         ChildGroup = "DLI-7/8",
         Task = "SCT",
...
MLS78_EPT_DOM <- read.csv(here("./CSV Files/MLS-78/MLS-78 DOM EPT.csv")) %>% 
  filter(!School == "GBCS") %>%
  mutate(Group = "HS7/8",
         GradeGroup = "7th/8th grade",
         ChildGroup = "MLS-7/8",
...
DLI5_EPT_DOM <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM EPT.csv")) %>% 
  mutate(Group = "HS5",
         GradeGroup = "5th grade",
         ChildGroup = "DLI-5",
         Task = "SCT",
...
MLS5_EPT_DOM <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM EPT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  mutate(Group = "HS5",
         GradeGroup = "5th grade",
         ChildGroup = "MLS-5",
...
# FCT
SDB_FCT_DOM <- read.csv(here("./CSV Files/SDB/SDB DOM FCT.csv")) %>% 
  mutate(Group = "SDBA",
         GradeGroup = "SDBA",
         ChildGroup = "N/A",
         Task = "MST",
...
HSA_FCT_DOM <- read.csv(here("./CSV Files/Adult HS/Adult HS DOM FCT.csv")) %>% 
  mutate(Group = "HSA",
         GradeGroup = "N/A",
         ChildGroup = "N/A",
         Task = "MST",
...
DLI78_FCT_DOM <- read.csv(here("./CSV Files/DLI-78/DLI-78 DOM FCT.csv")) %>% 
  mutate(Group = "HS7/8",
         GradeGroup = "7th/8th grade",
         ChildGroup = "DLI-7/8",
         Task = "MST",
...
MLS78_FCT_DOM <- read.csv(here("./CSV Files/MLS-78/MLS-78 DOM FCT.csv")) %>% 
  filter(!School == "GBCS") %>%
  mutate(Group = "HS7/8",
         GradeGroup = "7th/8th grade",
         ChildGroup = "MLS-7/8",
...
DLI5_FCT_DOM <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM FCT.csv")) %>% 
  mutate(Group = "HS5",
         GradeGroup = "5th grade",
         ChildGroup = "DLI-5",
         Task = "MST",
...
MLS5_FCT_DOM <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM FCT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  mutate(Group = "HS5",
         GradeGroup = "5th grade",
         ChildGroup = "MLS-5",
...
Master_Age_Subj$Task <- factor(Master_Age_Subj$Task, levels = c("SCT", "MST"))
```
...
Master_Age_DOM$Task <- factor(Master_Age_DOM$Task, levels = c("SCT", "MST"))
```
...
--
- These theories differ in 3 key dimensions:
...
--
- In generative studies, the notion of complexity has often been defined as the number of syntactic projections (e.g., Scontras & Laleko, 2021)
...
--
-
**Do HSs show similarities with Spanish-dominant bilinguals at the group and individual levels?**
...
--
- Similar levels of production/selection across structures; no clear differences between DOM and subjunctive


--
- Prediction #2 not supported


--
- More work is needed to distinguish between interface and acquisition timing effects
...
--
- Prediction #4 partially supported
...
--
- No clear difference between timing of acquisition and interface variability


--
- HSs' overall knowledge appears to be different (*rate* AND *route*) when compared to adult populations of native speakers
