...
# Load DOM data
## EPT
SDB_EPT <- read.csv(here("./CSV Files/SDB/SDB DOM EPT.csv")) %>% 
  mutate(Group = "SDBA",
         Task = "Production")
...
DLI5_EPT <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM EPT.csv")) %>% 
  mutate(Group = "HS5",
         Task = "Production")
...
## FCT
SDB_FCT <- read.csv(here("./CSV Files/SDB/SDB DOM FCT.csv")) %>% 
  mutate(Group = "SDBA",
         Task = "Forced Choice")
...
DLI5_FCT <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM FCT.csv")) %>% 
  mutate(Group = "HS5",
         Task = "Forced Choice")
