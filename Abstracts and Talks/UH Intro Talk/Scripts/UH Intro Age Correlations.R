...
## EPT
SDB_EPT_Subj <- read_csv(here("./CSV Files/SDB/SDB Subjunctive EPT.csv")) %>%
...
## FCT
SDB_FCT_Subj <- read_csv(here("./CSV Files/SDB/SDB Subjunctive FCT.csv")) %>%
  filter(Property == "Intensional subjunctive") %>% 
  mutate(Group = "SDBA")
...
# Load DOM data
## EPT
SDB_EPT_DOM <- read_csv(here("./CSV Files/SDB/SDB DOM EPT.csv")) %>%
...
## FCT
SDB_FCT_DOM <- read_csv(here("./CSV Files/SDB/SDB DOM FCT.csv")) %>%
