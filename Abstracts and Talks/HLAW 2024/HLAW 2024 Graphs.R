...
DLI78_DOM_EPT <- read.csv(here("./CSV Files/DLI-78/DLI-78 DOM EPT.csv")) %>% 
  mutate(Group = "Immersion-7/8",
         Task = "Production",
         School = "DLI",
         Age = "7th/8th")

MLS78_DOM_EPT <- read.csv(here("./CSV Files/MLS-78/MLS-78 DOM EPT.csv")) %>% 
  filter(!School == "GBCS") %>%
...
DLI5_DOM_EPT <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM EPT.csv")) %>% 
  mutate(Group = "Immersion-5",
         Task = "Production",
         School = "DLI",
         Age = "5th")

MLS5_DOM_EPT <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM EPT.csv")) %>% 
  filter(!School == "GBCS") %>% 
...
DLI78_DOM_FCT <- read.csv(here("./CSV Files/DLI-78/DLI-78 DOM FCT.csv")) %>% 
  mutate(Group = "Immersion-7/8",
         Task = "Selection",
         School = "DLI",
         Age = "7th/8th")

MLS78_DOM_FCT <- read.csv(here("./CSV Files/MLS-78/MLS-78 DOM FCT.csv")) %>% 
  filter(!School == "GBCS") %>%
  mutate(Group = "Monolingual-7/8",
         Task = "Selection",
         School = "MLS",
...
DLI5_DOM_FCT <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM FCT.csv")) %>% 
  mutate(Group = "Immersion-5",
         Task = "Selection",
         School = "DLI",
         Age = "5th")

MLS5_DOM_FCT <- read.csv(here("./CSV Files/MLS-5/MLS-5 DOM FCT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  mutate(Group = "Monolingual-5",
         Task = "Selection",
         School = "MLS",
...
DLI78_Subj_EPT <- read.csv(here("./CSV Files/DLI-78/DLI-78 Subjunctive EPT.csv")) %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Immersion-7/8",
         Task = "Production",
         Mood = "Subjunctive",
...
MLS78_Subj_EPT <- read.csv(here("./CSV Files/MLS-78/MLS-78 Subjunctive EPT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Monolingual-7/8",
         Task = "Production",
...
DLI5_Subj_EPT <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive EPT.csv")) %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Immersion-5",
         Task = "Production",
         Mood = "Subjunctive",
...
MLS5_Subj_EPT <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive EPT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Monolingual-5",
         Task = "Production",
...
DLI78_Subj_FCT <- read.csv(here("./CSV Files/DLI-78/DLI-78 Subjunctive FCT.csv")) %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Immersion-7/8",
         Task = "Selection",
         Mood = "Subjunctive",
...
MLS78_Subj_FCT <- read.csv(here("./CSV Files/MLS-78/MLS-78 Subjunctive FCT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Monolingual-7/8",
         Task = "Selection",
...
DLI5_Subj_FCT <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive FCT.csv")) %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Immersion-5",
         Task = "Selection",
         Mood = "Subjunctive",
...
MLS5_Subj_FCT <- read.csv(here("./CSV Files/MLS-5/MLS-5 Subjunctive FCT.csv")) %>% 
  filter(!School == "GBCS") %>% 
  filter(Short_Prop == "Intensional") %>% 
  mutate(Group = "Monolingual-5",
         Task = "Selection",
