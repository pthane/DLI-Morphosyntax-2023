...
Aggregate$Group <- factor(Aggregate$Group, levels = c("Adults", "DLBE-7/8", "MLS-7/8", "DLBE-5", "MLS-5"))
...
ggsave(filename = here("Manuscripts", "Multiple Baselines", "Graphs", "Multiple Baselines Figure 5.pdf"),
       plot = Ind_Diffs,
       device = "pdf",
       width = 6.5,
       height = 3,
